...
if [ "$3" == "view" ]; then
  ...
  CUDA_LAUNCH_BLOCKING=1 python gui.py -s /media/barry/56EA40DEEA40BBCD/DATA/$SAVEDIR/ --expname "$SAVEDIR/$EXP_NAME" --configs arguments/studio4.py --test_iterations 2000
fi
