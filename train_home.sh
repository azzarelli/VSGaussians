...
if [ "$3" == "render" ]; then
  ...
  CUDA_LAUNCH_BLOCKING=1 python gui.py -s /media/barry/56EA40DEEA40BBCD/DATA/$SAVEDIR/ --expname "home/$SAVEDIR/$EXP_NAME" --configs arguments/dynerf/steak.py --test_iterations 1000 --bundle-adjust --downsample 1
fi
