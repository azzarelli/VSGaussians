...
CUDA_LAUNCH_BLOCKING=1 python gui.py -s /media/barry/56EA40DEEA40BBCD/DATA/$SAVEDIR/ --expname "$SAVEDIR/canonloss_04" --configs arguments/lcan04.py --test_iterations 2000
CUDA_LAUNCH_BLOCKING=1 python gui.py -s /media/barry/56EA40DEEA40BBCD/DATA/$SAVEDIR/ --expname "$SAVEDIR/canonloss_08" --configs arguments/lcan08.py --test_iterations 2000
CUDA_LAUNCH_BLOCKING=1 python gui.py -s /media/barry/56EA40DEEA40BBCD/DATA/$SAVEDIR/ --expname "$SAVEDIR/canonloss_10" --configs arguments/lcan10.py --test_iterations 2000
